...
exports.search = function(query, callback) {
	...
	request("https://api.domainr.com/v1/api/json/search?client_id=node_connor&q=" + encodeURI(query), function(err, response, body) {
...
exports.info = function(query, callback) {
	...
	request("https://api.domainr.com/v1/api/json/info?client_id=node_connor&q=" + query, function(err, response, body) {
